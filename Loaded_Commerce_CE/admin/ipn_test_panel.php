...
<table border="0" width="780" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="0" class="box">
          <tr>
            <td align="center"><img border="0" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG_LANGUAGES . '../modules/payment/paypal/images/loaded_header_logo.gif'; ?>" alt="CRE Loaded"  title=" osCommerce " /></td>
          </tr>
          <tr>
