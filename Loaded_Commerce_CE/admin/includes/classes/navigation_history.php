...
*/
  ...
  class navigationHistory {
    ...
    function navigationHistory() {
      if ( ! isset($_SESSION['navigationHistory_data']) ) {
        $this->reset();
        $_SESSION['navigationHistory_data'] = array('path' => array(),
                                               'snapshot' => array(),
                                               );
      }
      $this->path =& $_SESSION['navigationHistory_data']['path'];
      $this->snapshot =& $_SESSION['navigationHistory_data']['snapshot'];
    }
