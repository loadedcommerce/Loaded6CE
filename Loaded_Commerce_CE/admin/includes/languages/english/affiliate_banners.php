...
define('TEXT_BANNERS_STATUS_ACTIVE','Active: ');
define('TEXT_BANNERS_STATUS_INACTIVE','In-active: ');
define('TEXT_BANNERS_TITLE', 'Banner Title:'); 
define('TEXT_BANNERS_LINKED_PRODUCT','Product ID');
define('TEXT_BANNERS_LINKED_PRODUCT_NOTE','Leave blank if you do not wish to link a product.');
define('TEXT_BANNERS_LINKED_CATEGORY','Category ID');
define('TEXT_BANNERS_LINKED_CATEGORY_NOTE','Leave blank if you do not wish to link any category.');
...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_HELP', 'Select the number from the popup window and enter the number in the field.');

define('TEXT_INFO_DELETE_INTRO','Are you sure?');
