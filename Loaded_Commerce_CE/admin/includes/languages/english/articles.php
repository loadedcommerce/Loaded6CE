...
*/
define('ARTICLES_GUEST', ' Guest');
define('ARTICLES_SHOW', ' Show');
define('ARTICLES_HIDE', ' Hide');
define('EDIT_TEXT_ARTICLES_GROUP_ACCESS','Edit Article');
define('NEW_TEXT_ARTICLES_GROUP_ACCESS','New Article');
define('TEXT_ARTICLES_GROUP_ACCESS','Group Access');
