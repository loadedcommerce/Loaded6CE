...
<script type="text/javascript">
  function form_validate() {
    var msg_str = '';   
    if(document.zones.geo_zone_name.value == '') {
  ...
  if ($action == 'list') {
    ...
    switch ($action) {
      case 'new_zone':
        ...
        $contents = array('form' => tep_draw_form('zones', FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $_GET['zID'] . '&action=insert_zone','post','onSubmit="return form_validate();"'));
      ...
      case 'edit_zone':
        ...
        $contents = array('form' => tep_draw_form('zones', FILENAME_GEO_ZONES, 'zpage=' . $_GET['zpage'] . '&zID=' . $zInfo->geo_zone_id . '&action=save_zone','post','onSubmit="return form_validate();"'));
