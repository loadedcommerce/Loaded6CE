      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td align="right"><?php echo '<a href="' . tep_href_link(FILENAME_EDIT_ORDERS, tep_get_all_get_params(array('action')), 'SSL') . '">' . tep_image_button('button_page_edit.png', IMAGE_EDIT) . '</a> &nbsp; '; ?>
            </td>
          </tr>
        </table></td>
      </tr>
