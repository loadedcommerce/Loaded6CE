...
<?php
  ...
  $info_box_contents[] = array('text'  => CVV_HELP_TITLE );
  new popupBoxHeading($info_box_contents, false, false);

  $info_box_contents = array();
  $info_box_contents[] = array('text'  =>  CVV_HELP_QUEST1);
  $info_box_contents[] = array('text'  =>  CVV_HELP_ANS1);
  $info_box_contents[] = array('text'  =>  CVV_HELP_QUEST2);
  $info_box_contents[] = array('text'  =>  CVV_HELP_ANS2);
  $info_box_contents[] = array('text'  =>  tep_image(DIR_WS_IMAGES . 'cvm_help1.jpg','CVV Help'));
  $info_box_contents[] = array('text'  =>  CVV_HELP_ANS3);
  $info_box_contents[] = array('text'  =>  tep_image(DIR_WS_IMAGES . 'cvm_help2.jpg','CVV Help'));
