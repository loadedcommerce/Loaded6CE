...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_XC_MARK_IMG', 'https://www.paypal.com/en_US/i/logo/PayPal_mark_37x23.gif');
  define('FILENAME_EC_PROCESS', 'xc_process.php');
  ...
  function create_temp_customer($customer_info) {
    ...
    if (tep_db_num_rows($query) > 0) {
      ...
      $sql_data_array = array('customers_id' => $customer_id,
                              ...
                              'entry_suburb' => $customer_info['SHIPTOSTREET2'],
  ...
  if ( $ec_enabled && strstr($_SERVER['SCRIPT_NAME'], FILENAME_CHECKOUT_SHIPPING) && tep_not_null($_GET['token']) && tep_not_null($_GET['PayerID']) ) {
  ...
  if ( $ec_enabled && strstr($_SERVER['SCRIPT_NAME'], FILENAME_CHECKOUT_SHIPPING) ) {
  ...
  if ( $ec_enabled && strstr($_SERVER['SCRIPT_NAME'], FILENAME_CHECKOUT_CONFIRMATION) && isset($_POST['payment']) && $_POST['payment'] == 'paypal_xc' ) {
