...
*/
 define('MODULE_SHIPPING_UPSXML_RATES_TEXT_TITLE', 'United Parcel Service Advanced');
 if (defined('MODULE_SHIPPING_UPSXML_DIMENSIONS_SUPPORTED') && MODULE_SHIPPING_UPSXML_DIMENSIONS_SUPPORTED != 'No') {
   define('MODULE_SHIPPING_UPSXML_RATES_TEXT_DESCRIPTION', 'United Parcel Service Advanced<br><a href="' . tep_href_link(FILENAME_PACKAGING) . '">Packages Settings</a>');
 } else {
   define('MODULE_SHIPPING_UPSXML_RATES_TEXT_DESCRIPTION', 'United Parcel Service Advanced');
 }
