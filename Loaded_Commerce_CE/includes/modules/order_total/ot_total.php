...
*/
  ...
  class ot_total {
    ...
    function ot_total() {
      $this->code = 'ot_total';
      $this->title = (defined('MODULE_ORDER_TOTAL_TOTAL_TITLE')) ? MODULE_ORDER_TOTAL_TOTAL_TITLE : '';
      $this->description = (defined('MODULE_ORDER_TOTAL_TOTAL_DESCRIPTION')) ? MODULE_ORDER_TOTAL_TOTAL_DESCRIPTION : '';
      $this->enabled = (defined('MODULE_ORDER_TOTAL_TOTAL_STATUS') && MODULE_ORDER_TOTAL_TOTAL_STATUS == 'true') ? true : false;
      $this->sort_order = (defined('MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER')) ? (int)MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER : 110;
      $this->output = array();      
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER', '110', 'Sort order of display.', '6', '2', now())");
    }
