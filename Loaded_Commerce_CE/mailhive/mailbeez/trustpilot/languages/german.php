...
*/
	...
	if (file_exists(DIR_FS_CATALOG . 'mailhive/mailbeez/trustpilot/languages/' . $_SESSION['language'] . '_promo' . $file_extension)) {
		include(DIR_FS_CATALOG . 'mailhive/mailbeez/trustpilot/languages/' . $_SESSION['language'] . '_promo' . $file_extension);
	}	elseif (file_exists(DIR_FS_CATALOG . 'mailhive/mailbeez/trustpilot/languages/english_promo' . $file_extension)) {
		include(DIR_FS_CATALOG . 'mailhive/mailbeez/trustpilot/languages/english_promo' . $file_extension);
	}
