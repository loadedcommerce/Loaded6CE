...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
   ...
   <tr>
    <td class="pageHeading"><?php echo MAILBEEZ_REPORT_BLOCK_TEXT_TITLE; ?></td>
  </tr>
</table></td>
      </tr>
      <tr>
...
<?php
  ...
  $report_query_raw = "select *, c.customers_email_address from " . TABLE_MAILBEEZ_BLOCK . " b, " . TABLE_CUSTOMERS . " c where b.customers_id = c.customers_id order by autoemail_id DESC";
...
?>
              <tr class="dataTableRow" onmouseover="this.className='dataTableRowOver';this.style.cursor='pointer'" onmouseout="this.className='dataTableRow'">
                ...
                <td class="dataTableContent"><?php echo $report['date_block']; ?>&nbsp;</td>								
                <td class="dataTableContent"><?php echo $report['module']; ?></td>
                <td class="dataTableContent"><?php echo $report['customers_id']; ?>&nbsp;</td>								
                <td class="dataTableContent"><?php echo $report['customers_email_address']; ?>&nbsp;</td>					
                <td class="dataTableContent"><?php echo constant('BLOCK_SOURCE_' . $report['source']); ?>&nbsp;</td>
