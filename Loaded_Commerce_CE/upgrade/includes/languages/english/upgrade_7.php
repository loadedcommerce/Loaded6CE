...
//Install text
define('TEXT_INSTALL_1', '<b>Your upgrade of ' . VERSION . ' is now finished!</b>');
...
define('TEXT_INSTALL_7', 'You must <b>delete</b> the upgrade directory. Failure to do so allows anyone to change your username and password.');
