...
/*
  ...
  Copyright (c) 2016 Loaded Commerce
  Copyright (c) 2003 osCommerce

  Released under the GNU General Public License
*/
  define('TEMPLATE_NAME_REF', 'Seven Of Six');
  define('TEMPLATE_VERSION', '1.1');
  define('TEMPLATE_SYSTEM', 'ATS');
  define('TEMPLATE_AUTHOR', 'TheReactorWorks INC.');

  define('TEMPLATE_STYLE', DIR_WS_TEMPLATES . TEMPLATE_NAME . "/stylesheet.css");

  //used to get boxes from default
  define('DIR_FS_TEMPLATE_BOXES', DIR_FS_TEMPLATES . 'sevenofsix/boxes/');
  define('DIR_FS_TEMPLATE_MAINPAGES', DIR_FS_TEMPLATES . 'sevenofsix/mainpage_modules/');
  define('DIR_WS_TEMPLATE_IMAGES', DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/');

  //which files to use
  define('TEMPLATE_BOX_TPL', DIR_WS_TEMPLATES . 'sevenofsix/boxes.tpl.php');
  define('TEMPLATE_HTML_OUT', DIR_WS_TEMPLATES . 'sevenofsix/extra_html_output.php' );
