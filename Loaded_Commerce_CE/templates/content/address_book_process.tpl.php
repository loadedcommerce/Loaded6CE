...
if (isset($_GET['edit'])) { echo ' <h1 class="no-margin-top">'. HEADING_TITLE_MODIFY_ENTRY .'</h1>'; } elseif (isset($_GET['delete'])) { echo ' <h1 class="no-margin-top">' . HEADING_TITLE_DELETE_ENTRY .' </h1>'; } else { echo ' <h1 class="no-margin-top">'. HEADING_TITLE_ADD_ENTRY .'</h1>'; } 
// BOF: Lango Added for template MOD
}else{
