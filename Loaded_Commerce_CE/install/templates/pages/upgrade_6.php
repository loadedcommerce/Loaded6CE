...
*/
  require('includes/languages/' . $language . '/upgrade_6.php');
...
<p>&nbsp;</p>
<?php
echo osc_draw_form('skipCrem', basename($_SERVER['PHP_SELF']), 'step=7', 'post');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="main" align="center"><input name="Submit" type="button" class="button" value="<?php echo TEXT_GET_SUPPORT;?>" onclick="javascript:void(history.go(-1))">
      <br>
      <br>
      <a href="javascript:void(0);" onclick="document.skipCrem.submit(); return false;"><?php echo NO_THANKS;?></a></td>
  </tr>
</table>
</form>