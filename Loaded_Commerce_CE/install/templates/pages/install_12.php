<?php
  ...
  */
  ...
  require('includes/languages/' . $language . '/install_12.php');

  include('../includes/configure.php');
?>

  <h1 align="center"><?php if ($_POST['method'] == 'upgrade') { echo TEXT_INSTALL_2; } else { echo TEXT_INSTALL_1; } ?></h1>
  <?php
    echo TEXT_INSTALL_3; 
    if ($_POST['method'] == 'upgrade') {
      echo TEXT_INSTALL_4; 
    } else {
      echo TEXT_INSTALL_7; 
    }  
