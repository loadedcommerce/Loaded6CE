...
//Install text
define('TEXT_INSTALL_1', '<b>Your installation of ' . VERSION . ' is now finished!</b>');
define('TEXT_INSTALL_3', '<p>Next,<br><br>If you need your customers to pay you with credit cards:<br>
